...
class UnitApi(object):
	...
	def get_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/units/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, unit_d_t_o, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, unit_d_t_o, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, unit_d_t_o, **kwargs)
			return data

	def update_with_http_info(self, web_id, unit_d_t_o, **kwargs):
		...
		if ('unit_d_t_o' not in params) or (params['unit_d_t_o'] is None):
			raise ValueError("Missing the required parameter `unit_d_t_o` when calling `update_with_http_info`")
		...
		return self.api_client.call_api('/units/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/units/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,

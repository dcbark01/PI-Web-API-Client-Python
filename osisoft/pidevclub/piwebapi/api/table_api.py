...
class TableApi(object):
	...
	def get_with_http_info(self, web_id, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, table, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, table, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, table, **kwargs)
			return data

	def update_with_http_info(self, web_id, table, **kwargs):
		...
		if ('table' not in params) or (params['table'] is None):
			raise ValueError("Missing the required parameter `table` when calling `update_with_http_info`")
		...
		return self.api_client.call_api('/tables/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_categories_with_http_info(self, web_id, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/categories', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_data(self, web_id, selected_fields, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_data_with_http_info(web_id, selected_fields, **kwargs)
		else:
			(data) = self.get_data_with_http_info(web_id, selected_fields, **kwargs)
			return data

	def get_data_with_http_info(self, web_id, selected_fields, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method get_data_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `get_data_with_http_info`")
		...
		return self.api_client.call_api('/tables/{webId}/data', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update_data(self, web_id, data, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_data_with_http_info(web_id, data, **kwargs)
		else:
			(data) = self.update_data_with_http_info(web_id, data, **kwargs)
			return data

	def update_data_with_http_info(self, web_id, data, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method update_data_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `update_data_with_http_info`")
		if ('data' not in params) or (params['data'] is None):
			raise ValueError("Missing the required parameter `data` when calling `update_data_with_http_info`")
		...
		return self.api_client.call_api('/tables/{webId}/data', 'PUT',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_with_http_info(self, web_id, user_identity, force_refresh, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/security', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entries_with_http_info(self, web_id, name_filter, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/securityentries', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def create_security_entry_with_http_info(self, web_id, security_entry, apply_to_children, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/securityentries', 'POST',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entry_by_name_with_http_info(self, name, web_id, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/securityentries/{name}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update_security_entry_with_http_info(self, name, web_id, security_entry, apply_to_children, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/securityentries/{name}', 'PUT',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_security_entry_with_http_info(self, name, web_id, apply_to_children, **kwargs):
		...
		return self.api_client.call_api('/tables/{webId}/securityentries/{name}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,

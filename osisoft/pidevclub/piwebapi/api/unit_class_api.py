...
class UnitClassApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/unitclasses', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/unitclasses/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, unit_class_d_t_o, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, unit_class_d_t_o, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, unit_class_d_t_o, **kwargs)
			return data

	def update_with_http_info(self, web_id, unit_class_d_t_o, **kwargs):
		all_params = ['web_id', 'unit_class_d_t_o']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		all_params.append('_request_timeout')
		...
		if ('unit_class_d_t_o' not in params) or (params['unit_class_d_t_o'] is None):
			raise ValueError("Missing the required parameter `unit_class_d_t_o` when calling `update_with_http_info`")
		...
		if 'web_id' in params:
			if (params['web_id'] is not None):
				path_params['webId'] = params['web_id']
		if 'unit_class_d_t_o' in params:
			body_params = params['unit_class_d_t_o']
		...
		return self.api_client.call_api('/unitclasses/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/unitclasses/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_canonical_unit(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
	...
	def get_canonical_unit_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		all_params = ['web_id', 'selected_fields', 'web_id_type']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method get_canonical_unit_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `get_canonical_unit_with_http_info`")
		...
		return self.api_client.call_api('/unitclasses/{webId}/canonicalunit', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_units(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
	...
	def get_units_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		all_params = ['web_id', 'selected_fields', 'web_id_type']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method get_units_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `get_units_with_http_info`")
		...
		return self.api_client.call_api('/unitclasses/{webId}/units', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def create_unit(self, web_id, unit_d_t_o, web_id_type=None, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
	...
	def create_unit_with_http_info(self, web_id, unit_d_t_o, web_id_type=None, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method create_unit_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `create_unit_with_http_info`")
		if ('unit_d_t_o' not in params) or (params['unit_d_t_o'] is None):
			raise ValueError("Missing the required parameter `unit_d_t_o` when calling `create_unit_with_http_info`")
		...
		return self.api_client.call_api('/unitclasses/{webId}/units', 'POST',
				path_params,
				query_params,
				header_params,
				body =body_params,

...
class SecurityIdentityApi(object):
	...
	def get_security_mappings(self, web_id, selected_fields, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_security_mappings_with_http_info(web_id, selected_fields, **kwargs)
		else:
			(data) = self.get_security_mappings_with_http_info(web_id, selected_fields, **kwargs)
			return data

	def get_security_mappings_with_http_info(self, web_id, selected_fields, **kwargs):
		all_params = ['web_id', 'selected_fields']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')

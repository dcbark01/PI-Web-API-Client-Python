...
class SecurityIdentityApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/securityidentities', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PISecurityIdentity',
	...
	def get_with_http_info(self, web_id, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/securityidentities/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, security_identity, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, security_identity, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, security_identity, **kwargs)
			return data

	def update_with_http_info(self, web_id, security_identity, **kwargs):
		...
		if ('security_identity' not in params) or (params['security_identity'] is None):
			raise ValueError("Missing the required parameter `security_identity` when calling `update_with_http_info`")
		...
		return self.api_client.call_api('/securityidentities/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/securityidentities/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_with_http_info(self, web_id, user_identity, force_refresh, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/securityidentities/{webId}/security', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entries_with_http_info(self, web_id, name_filter, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/securityidentities/{webId}/securityentries', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entry_by_name_with_http_info(self, name, web_id, selected_fields, web_id_type, **kwargs):
		...
		return self.api_client.call_api('/securityidentities/{webId}/securityentries/{name}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_mappings(self, web_id, selected_fields, web_id_type, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_security_mappings_with_http_info(web_id, selected_fields, web_id_type, **kwargs)
		else:
			(data) = self.get_security_mappings_with_http_info(web_id, selected_fields, web_id_type, **kwargs)
			return data

	def get_security_mappings_with_http_info(self, web_id, selected_fields, web_id_type, **kwargs):
		all_params = ['web_id', 'selected_fields', 'web_id_type']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		return self.api_client.call_api('/securityidentities/{webId}/securitymappings', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,

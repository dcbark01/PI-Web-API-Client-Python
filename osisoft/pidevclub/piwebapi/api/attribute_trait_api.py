...
class AttributeTraitApi(object):
	...
	def get_by_category_with_http_info(self, category, selected_fields=None, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					...
					" to method get_by_category_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('category' not in params) or (params['category'] is None):
			raise ValueError("Missing the required parameter `category` when calling `get_by_category_with_http_info`")
		...
		return self.api_client.call_api('/attributetraits', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PIItemsAttributeTrait',
	...
	def get_with_http_info(self, name, selected_fields=None, **kwargs):
		...
		if ('name' not in params) or (params['name'] is None):
			raise ValueError("Missing the required parameter `name` when calling `get_with_http_info`")
		...
		return self.api_client.call_api('/attributetraits/{name}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				post_params =form_params,
				files =local_var_files,
				response_type ='PIAttributeTrait',
				callback =params.get('callback'),
				_return_http_data_only =params.get('_return_http_data_only'),
				_preload_content =params.get('_preload_content', True),
				_request_timeout=params.get('_request_timeout'),

...
class EnumerationValueApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/enumerationvalues', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PIEnumerationValue',
	...
	def get_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/enumerationvalues/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update_enumeration_value(self, web_id, enumeration_value, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_enumeration_value_with_http_info(web_id, enumeration_value, **kwargs)
		else:
			(data) = self.update_enumeration_value_with_http_info(web_id, enumeration_value, **kwargs)
			return data

	def update_enumeration_value_with_http_info(self, web_id, enumeration_value, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method update_enumeration_value_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `update_enumeration_value_with_http_info`")
		if ('enumeration_value' not in params) or (params['enumeration_value'] is None):
			raise ValueError("Missing the required parameter `enumeration_value` when calling `update_enumeration_value_with_http_info`")
		...
		return self.api_client.call_api('/enumerationvalues/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_enumeration_value(self, web_id, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.delete_enumeration_value_with_http_info(web_id, **kwargs)
		else:
			(data) = self.delete_enumeration_value_with_http_info(web_id, **kwargs)
			return data

	def delete_enumeration_value_with_http_info(self, web_id, **kwargs):
		all_params = ['web_id']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method delete_enumeration_value_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `delete_enumeration_value_with_http_info`")
		...
		return self.api_client.call_api('/enumerationvalues/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,

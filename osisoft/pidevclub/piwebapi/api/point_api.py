...
class PointApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/points', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_with_http_info(self, web_id, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/points/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, point_d_t_o, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, point_d_t_o, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, point_d_t_o, **kwargs)
			return data

	def update_with_http_info(self, web_id, point_d_t_o, **kwargs):
		all_params = ['web_id', 'point_d_t_o']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		all_params.append('_request_timeout')
		...
		if ('point_d_t_o' not in params) or (params['point_d_t_o'] is None):
			raise ValueError("Missing the required parameter `point_d_t_o` when calling `update_with_http_info`")
		...
		return self.api_client.call_api('/points/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/points/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_attributes(self, web_id, name, name_filter, selected_fields, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_attributes_with_http_info(web_id, name, name_filter, selected_fields, **kwargs)
		else:
			(data) = self.get_attributes_with_http_info(web_id, name, name_filter, selected_fields, **kwargs)
			return data

	def get_attributes_with_http_info(self, web_id, name, name_filter, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/points/{webId}/attributes', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				post_params =form_params,
				files =local_var_files,
				response_type ='PIItemsPointAttribute',
				callback =params.get('callback'),
				_return_http_data_only =params.get('_return_http_data_only'),
				_preload_content =params.get('_preload_content', True),
				_request_timeout=params.get('_request_timeout'),
	...
	def get_attribute_by_name(self, name, web_id, selected_fields, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_attribute_by_name_with_http_info(name, web_id, selected_fields, **kwargs)
		else:
			(data) = self.get_attribute_by_name_with_http_info(name, web_id, selected_fields, **kwargs)
			return data

	def get_attribute_by_name_with_http_info(self, name, web_id, selected_fields, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method get_attribute_by_name_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('name' not in params) or (params['name'] is None):
			raise ValueError("Missing the required parameter `name` when calling `get_attribute_by_name_with_http_info`")
		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `get_attribute_by_name_with_http_info`")
		...
		return self.api_client.call_api('/points/{webId}/attributes/{name}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				post_params =form_params,
				files =local_var_files,
				response_type ='PIPointAttribute',
				callback =params.get('callback'),
				_return_http_data_only =params.get('_return_http_data_only'),
				_preload_content =params.get('_preload_content', True),
				_request_timeout=params.get('_request_timeout'),
	...
	def update_attribute_value(self, web_id, name, value, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_attribute_value_with_http_info(web_id, name, value, **kwargs)
		else:
			(data) = self.update_attribute_value_with_http_info(web_id, name, value, **kwargs)
			return data

	def update_attribute_value_with_http_info(self, web_id, name, value, **kwargs):
		all_params = ['web_id', 'name', 'value']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		all_params.append('_request_timeout')
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method update_attribute_value_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `update_attribute_value_with_http_info`")
		if ('name' not in params) or (params['name'] is None):
			raise ValueError("Missing the required parameter `name` when calling `update_attribute_value_with_http_info`")
		if ('value' not in params) or (params['value'] is None):
			raise ValueError("Missing the required parameter `value` when calling `update_attribute_value_with_http_info`")
		...
		return self.api_client.call_api('/points/{webId}/attributes/{name}', 'PUT',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_multiple_with_http_info(self, as_parallel, include_mode, path, selected_fields, web_id, **kwargs):
		...
		return self.api_client.call_api('/points/multiple', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				post_params =form_params,
				files =local_var_files,
				response_type ='PIItemsItemPoint',
				callback =params.get('callback'),
				_return_http_data_only =params.get('_return_http_data_only'),
				_preload_content =params.get('_preload_content', True),
				_request_timeout=params.get('_request_timeout'),

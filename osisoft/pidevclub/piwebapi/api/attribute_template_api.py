...
class AttributeTemplateApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/attributetemplates', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PIAttributeTemplate',
	...
	def get_with_http_info(self, web_id, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/attributetemplates/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update_with_http_info(self, web_id, template, **kwargs):
		...
		return self.api_client.call_api('/attributetemplates/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/attributetemplates/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_attribute_templates(self, web_id, selected_fields, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_attribute_templates_with_http_info(web_id, selected_fields, **kwargs)
		else:
			(data) = self.get_attribute_templates_with_http_info(web_id, selected_fields, **kwargs)
			return data

	def get_attribute_templates_with_http_info(self, web_id, selected_fields, **kwargs):
		all_params = ['web_id', 'selected_fields']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		return self.api_client.call_api('/attributetemplates/{webId}/attributetemplates', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def create_attribute_template_with_http_info(self, web_id, template, **kwargs):
		...
		return self.api_client.call_api('/attributetemplates/{webId}/attributetemplates', 'POST',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_categories_with_http_info(self, web_id, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/attributetemplates/{webId}/categories', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,

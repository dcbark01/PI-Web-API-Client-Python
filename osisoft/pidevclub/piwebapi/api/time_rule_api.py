...
class TimeRuleApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/timerules', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/timerules/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, time_rule, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, time_rule, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, time_rule, **kwargs)
			return data

	def update_with_http_info(self, web_id, time_rule, **kwargs):
		all_params = ['web_id', 'time_rule']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		all_params.append('_request_timeout')
		...
		if ('time_rule' not in params) or (params['time_rule'] is None):
			raise ValueError("Missing the required parameter `time_rule` when calling `update_with_http_info`")
		...
		if 'web_id' in params:
			if (params['web_id'] is not None):
				path_params['webId'] = params['web_id']
		if 'time_rule' in params:
			body_params = params['time_rule']
		...
		return self.api_client.call_api('/timerules/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/timerules/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,

...
class EnumerationSetApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PIEnumerationSet',
	...
	def get_with_http_info(self, web_id, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, enumeration_set, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, enumeration_set, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, enumeration_set, **kwargs)
			return data

	def update_with_http_info(self, web_id, enumeration_set, **kwargs):
		...
		if ('enumeration_set' not in params) or (params['enumeration_set'] is None):
			raise ValueError("Missing the required parameter `enumeration_set` when calling `update_with_http_info`")
		...
		return self.api_client.call_api('/enumerationsets/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_values(self, web_id, selected_fields, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_values_with_http_info(web_id, selected_fields, **kwargs)
		else:
			(data) = self.get_values_with_http_info(web_id, selected_fields, **kwargs)
			return data

	def get_values_with_http_info(self, web_id, selected_fields, **kwargs):
		all_params = ['web_id', 'selected_fields']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		return self.api_client.call_api('/enumerationsets/{webId}/enumerationvalues', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				post_params =form_params,
				files =local_var_files,
				response_type ='PIItemsEnumerationValue',
				callback =params.get('callback'),
				_return_http_data_only =params.get('_return_http_data_only'),
				_preload_content =params.get('_preload_content', True),
				_request_timeout=params.get('_request_timeout'),
	...
	def create_value(self, web_id, enumeration_value, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.create_value_with_http_info(web_id, enumeration_value, **kwargs)
		else:
			(data) = self.create_value_with_http_info(web_id, enumeration_value, **kwargs)
			return data

	def create_value_with_http_info(self, web_id, enumeration_value, **kwargs):
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method create_value_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `create_value_with_http_info`")
		if ('enumeration_value' not in params) or (params['enumeration_value'] is None):
			raise ValueError("Missing the required parameter `enumeration_value` when calling `create_value_with_http_info`")
		...
		return self.api_client.call_api('/enumerationsets/{webId}/enumerationvalues', 'POST',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_with_http_info(self, web_id, user_identity, force_refresh, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}/security', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entries_with_http_info(self, web_id, name_filter, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}/securityentries', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def create_security_entry_with_http_info(self, web_id, security_entry, apply_to_children, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}/securityentries', 'POST',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entry_by_name_with_http_info(self, name, web_id, selected_fields, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}/securityentries/{name}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update_security_entry_with_http_info(self, name, web_id, security_entry, apply_to_children, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}/securityentries/{name}', 'PUT',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_security_entry_with_http_info(self, name, web_id, apply_to_children, **kwargs):
		...
		return self.api_client.call_api('/enumerationsets/{webId}/securityentries/{name}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,

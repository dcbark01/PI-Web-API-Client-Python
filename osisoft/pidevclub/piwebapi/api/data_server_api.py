...
class DataServerApi(object):
	...
	def get_points(self, web_id, max_count, name_filter, selected_fields, start_index, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_points_with_http_info(web_id, max_count, name_filter, selected_fields, start_index, **kwargs)
		else:
			(data) = self.get_points_with_http_info(web_id, max_count, name_filter, selected_fields, start_index, **kwargs)
			return data

	def get_points_with_http_info(self, web_id, max_count, name_filter, selected_fields, start_index, **kwargs):
	...
	def create_point(self, web_id, point_d_t_o, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.create_point_with_http_info(web_id, point_d_t_o, **kwargs)
		else:
			(data) = self.create_point_with_http_info(web_id, point_d_t_o, **kwargs)
			return data

	def create_point_with_http_info(self, web_id, point_d_t_o, **kwargs):

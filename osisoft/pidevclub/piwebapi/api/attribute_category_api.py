...
class AttributeCategoryApi(object):
	...
	def get_by_path_with_http_info(self, path, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PIAttributeCategory',
	...
	def get_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update(self, web_id, category, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.update_with_http_info(web_id, category, **kwargs)
		else:
			(data) = self.update_with_http_info(web_id, category, **kwargs)
			return data

	def update_with_http_info(self, web_id, category, **kwargs):
		all_params = ['web_id', 'category']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		all_params.append('_request_timeout')
		...
		if ('category' not in params) or (params['category'] is None):
			raise ValueError("Missing the required parameter `category` when calling `update_with_http_info`")
		...
		return self.api_client.call_api('/attributecategories/{webId}', 'PATCH',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_with_http_info(self, web_id, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_with_http_info(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}/security', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entries_with_http_info(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}/securityentries', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def create_security_entry_with_http_info(self, web_id, security_entry, apply_to_children=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}/securityentries', 'POST',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_security_entry_by_name_with_http_info(self, name, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}/securityentries/{name}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def update_security_entry_with_http_info(self, name, web_id, security_entry, apply_to_children=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}/securityentries/{name}', 'PUT',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def delete_security_entry_with_http_info(self, name, web_id, apply_to_children=None, **kwargs):
		...
		return self.api_client.call_api('/attributecategories/{webId}/securityentries/{name}', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,

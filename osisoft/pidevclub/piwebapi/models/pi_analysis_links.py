...
class PIAnalysisLinks(object):
	...
	def __init__(self, target=None, database=None, categories=None, template=None, analysis_rule=None, analysis_rule_plug_in=None, time_rule=None, time_rule_plug_in=None, security=None, security_entries=None):
	...
	def __eq__(self, other):
		if not isinstance(other, PIAnalysisLinks):
			return False

...
class PISecurityMappingLinks(object):
	swagger_types = {
		'asset_server': 'str',
	...
	def __init__(self, asset_server=None, security_identity=None, security=None, security_entries=None):
	...
	def __eq__(self, other):
		if not isinstance(other, PISecurityMappingLinks):
			return False

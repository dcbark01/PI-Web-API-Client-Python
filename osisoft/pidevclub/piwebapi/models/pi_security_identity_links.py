...
class PISecurityIdentityLinks(object):
	swagger_types = {
		'asset_server': 'str',
	...
	def __init__(self, asset_server=None, security_mappings=None, security=None, security_entries=None):
	...
	def __eq__(self, other):
		if not isinstance(other, PISecurityIdentityLinks):
			return False

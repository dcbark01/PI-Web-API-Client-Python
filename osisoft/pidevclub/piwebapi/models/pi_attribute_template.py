...
class PIAttributeTemplate(object):
	swagger_types = {
		'web_id': 'str',
		'id': 'str',
		'name': 'str',
	...
	def __eq__(self, other):
		if not isinstance(other, PIAttributeTemplate):
			return False
